...
def test_objective_2(verbose=False):
    ...
    for _ in range(n):
        score_p2, decoded_p2 = genetic_algorithm(objective=objective_p2, constraints=cons_p2,
                                                    bounds=bounds_p2, options=options, verbose=False, tetra=False)
...
def test_objective_3(verbose=False):
    ...
    for _ in range(n):
        score_p3, decoded_p3 = genetic_algorithm(objective=objective_p3, constraints=cons_p3,
                                                    bounds=bounds_p3, options=options, verbose=verbose, tetra=False)
